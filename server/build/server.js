...
app.get('/games/:id/ads', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return response.json(ads.map((ad => {
        return Object.assign(Object.assign({}, ad), { weekDays: ad.weekDays.split(','), hourStart: (0, convert_minutes_to_hours_string_1.convertMinutesToHoursString)(ad.hourStart), hourEnd: (0, convert_minutes_to_hours_string_1.convertMinutesToHoursString)(ad.hourEnd) });
    })));
}));
